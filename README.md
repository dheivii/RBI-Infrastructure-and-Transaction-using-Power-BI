# 📊 Analysis of RBI Banking Infrastructure and Transaction Trends Using Power BI

## Project Overview

This project analyzes banking infrastructure and transaction trends using data published by the Reserve Bank of India (RBI). The objective is to understand how banking services have evolved from 2020 to 2025, focusing on infrastructure growth, digital adoption, and transaction performance across banks and categories.

The project includes:

* Data cleaning and transformation
* Data modeling using Power BI
* Development of multiple interactive dashboards
* Extraction of meaningful insights for decision-making
...
* Infrastructure data (ATMs, POS, UPI QR, Debit/Credit Cards, etc.)
* Transaction data (count & value)
